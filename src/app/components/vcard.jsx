...
const VCardGenerator = () => {
  const [vCardLink] = useState("https://kara.com/vcard");
  ...
  return (
    <section id="vcard" className="py-4 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-8 max-w-screen-md">
        ...
        <div className="flex flex-col items-center bg-white shadow-md rounded-lg py-6 w-full">
          <div className="flex items-center my-4  ">
            <input
              type="text"
              value={vCardLink}
              readOnly
              className="flex-1 border border-gray-300 rounded-l-lg px-2 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-800"
            />
            <button
              onClick={handleCopy}
